...
for i = 3:length(idsResults)
    if idsResults(i, 1).isdir==1
        ...
        bar_all=[precision_1Canny,recall_1Canny,Fmeasure_1Canny;...
            precision_2ITS,recall_2ITS,Fmeasure_2ITS;...
            precision_3Otsu,recall_3Otsu,Fmeasure_3Otsu;...
            precision_6Sauvola,recall_6Sauvola,Fmeasure_6Sauvola;...
            precision_4MET,recall_4MET,Fmeasure_4MET;...
